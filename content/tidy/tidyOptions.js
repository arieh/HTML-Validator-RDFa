...
TidyOptions.prototype =
{
  ...
  start : function()
  {
    ...
    oTidyUtil.initCheckbox( "browser_hide" );
  ...
  {
    this.algorithmList.selectedIndex = (oTidyUtil.getCharPref("algorithm")=="tidy"?0:(oTidyUtil.getCharPref("algorithm")=="sp"?1:2));
    this.enableDisable();
  },
  ...
  {
    if( document.getElementById("tidy.options.browser_enable").checked )
    {
      document.getElementById("tidy.options.browser_hide").checked = false;
    }
  },
  
  onBrowserHide : function()
  {
    if( document.getElementById("tidy.options.browser_hide").checked )
    {
      document.getElementById("tidy.options.browser_enable").checked = false;
    }
  },
  ...
  onOk : function()
  {
    ...
    oTidyUtil.saveCheckbox( "browser_hide" );
    ...
    // Algorithm
    var algo = new Array("tidy", "sp", "serial" );
